      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{url('users/'.$item->id)}}" method="post">
                ...
                <div class="mb-3">
                    <small class="text-danger">leave it blank if you don't want to replace password</small>
                ...
                <div class="mb-3">
                    <input type="password" name="password_confirmation" id="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" value="{{old('confirm_password')}}" placeholder="Confirm Password">
